...
from core.apps.products.services.reviews import IReviewService, IReviewValidatorService
...
class CreateReviewUseCase:
    ...
    def execute(self, product_id: int, customer_token: str, review: ReviewEntity) -> ReviewEntity:
